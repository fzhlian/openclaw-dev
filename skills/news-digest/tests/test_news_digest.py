...
class NewsDigestScriptTests(unittest.TestCase):
    ...
    def test_build_query_splits_asymmetric_spaced_slashes(self) -> None:
        result = self.run_script(
            "build_query.py",
            "-k",
            "OpenAI /Gemini",
    ...
    def test_intake_check_normalizes_this_period_time_range_labels(self) -> None:
        result = self.run_script(
            "intake_check.py",
            "--topic",
            "OpenAI",
    ...
    def test_intake_check_normalizes_adjacent_period_time_range_labels(self) -> None:
        result = self.run_script(
            "intake_check.py",
            "--topic",
            "OpenAI",
    ...
    def test_intake_check_normalizes_weekday_colloquial_time_range_labels(self) -> None:
        result = self.run_script(
            "intake_check.py",
            "--topic",
            "OpenAI",
    ...
    def test_intake_check_splits_asymmetric_spaced_slashes(self) -> None:
        result = self.run_script(
            "intake_check.py",
            "--topic",
            "OpenAI /Gemini",
    ...
    def test_filter_results_splits_asymmetric_spaced_slashes_in_sites(self) -> None:
        input_path = self.write_json(
            [
                {"title": "BBC One", "url": "https://www.bbc.com/news/a", "snippet": "1"},
                {"title": "Google One", "url": "https://blog.google/ai/x", "snippet": "2"},
    ...
    def test_render_digest_normalizes_this_period_time_range_labels(self) -> None:
        input_path = self.write_json(
            {
                "results": [
                    {
    ...
    def test_render_digest_normalizes_adjacent_period_time_range_labels(self) -> None:
        input_path = self.write_json(
            {
                "results": [
                    {
    ...
    def test_render_digest_normalizes_weekday_colloquial_time_range_labels(self) -> None:
        input_path = self.write_json(
            {
                "results": [
                    {
    ...
    def test_render_digest_normalizes_asymmetric_spaced_slash_params(self) -> None:
        input_path = self.write_json(
            {
                "results": [
                    {
