...
def main() -> int:
    parser = argparse.ArgumentParser(description="Estimate AI participation heuristically.")
    ...
    print(json.dumps(assess_ai_likelihood(article).to_dict(), ensure_ascii=False, indent=2))
    return 0
